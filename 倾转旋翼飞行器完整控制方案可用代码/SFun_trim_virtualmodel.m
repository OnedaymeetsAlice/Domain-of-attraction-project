...
t_wing = 0; t_hover = 0;
global t_tran;                                                             %过渡时间
global taov0;global v0_down;                                               %终端条件     
v0_up = 23.5; v_tran = v0_up - v0_down;                                    %78。结束 
%S3 Vx导数
if t == 0 || t >= t_tran || tao > taov0-1  %状态变量的导数在起点和终点不可导，需要特殊处理(水平方向匀减速运动)
...
%accelerate_theta = 0;                                                      %第一阶段配平，对theta导数无要求
accelerate_vy = 0;
accelerate_height = 0;
accelerate_q = 0;

dx1 = (Fxt*cos(x(3)) - Fyt*sin(x(3)))/2 - accelerate_vx;                   %状态方程，计算系统状态微分          
